...
@@OVERFLOW: ;{
	...
	@@COLOR: ;{
		...
		MOV [WORD PTR BX], GREEN ;Cord do menu em movimento
	;}
	@@END_PROC:
	;FLUSH BUFFER {
		XOR AL, AL
...
;{
	;MENU INIT {
		...
		MOV [WORD PTR BX + 2], OFFSET STR_EXIT

		MOV BX, OFFSET MENU_TXT_COL
		MOV [WORD PTR BX]    , GREEN ; Cor do botao em movimento estatico
		MOV [WORD PTR BX + 2], WHITE
	;}
